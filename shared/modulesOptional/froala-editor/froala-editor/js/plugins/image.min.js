...
! function (e, t) {
  ...
  Ne = Ne && Ne.hasOwnProperty("default") ? Ne.default : Ne, Object.assign(Ne.POPUP_TEMPLATES, {
    ...
    function v(e) {
      void 0 === e && (e = !0);
      var t, a = Array.prototype.slice.call(A.el.querySelectorAll("img")),
        i = [];
      for (t = 0; t < a.length; t++)
        ...
        for (t = 0; t < s.length; t++) i.indexOf(s[t].getAttribute("src")) < 0 && A.events.trigger("image.removed", [S(s[t])]);
      if (s && e) {
        var o = [];
            ...
            A.events.on("keydown", function (e) {
              if (C) {
                var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                  a = e.which;
                (a !== n || 200 < e.timeStamp - r) && (i = 1), (a == Ne.KEYCODE.EQUALS || A.browser.mozilla && a == Ne.KEYCODE.FF_EQUALS) && t && !e.altKey ? i = ee.call(this, e, 1, 1, i) : (a == Ne.KEYCODE.HYPHEN || A.browser.mozilla && a == Ne.KEYCODE.FF_HYPHEN) && t && !e.altKey ? i = ee.call(this, e, 2, -1, i) : A.keys.ctrlKey(e) || a != Ne.KEYCODE.ENTER || (C.before("<br>"), O(C)), n = a, r = e.timeStamp
              }
    ...
    function Y(e, t, a) {
      var i, n = S(document.createElement("img")).attr("src", e);
      if (t && void 0 !== t)
        for (i in t) t.hasOwnProperty(i) && "link" != i && (" data-".concat(i, '="').concat(t[i], '"'), n.attr("data-".concat(i), t[i]));
      ...
      if (void 0 !== e && 0 < e.length) {
        ...
        if (A.drag_support.formdata && (a = A.drag_support.formdata ? new FormData : null), a) {
          ...
          if (!1 !== A.opts.imageUploadToS3)
            for (n in a.append("key", A.opts.imageUploadToS3.keyStart + (new Date).getTime() + "-" + (i.name || "untitled")), a.append("success_action_status", "201"), a.append("X-Requested-With", "xhr"), a.append("Content-Type", i.type), A.opts.imageUploadToS3.params) A.opts.imageUploadToS3.params.hasOwnProperty(n) && a.append(n, A.opts.imageUploadToS3.params[n]);
          ...
          var r, o, s = A.opts.imageUploadURL,
          ...
          if (A.opts.imageUploadToAzure) {
            ...
            for (n in p.setRequestHeader("x-ms-version", "2019-07-07"), p.setRequestHeader("x-ms-date", f), p.setRequestHeader("Content-Type", i.type), p.setRequestHeader("x-ms-blob-type", "BlockBlob"), A.opts.imageUploadParams) A.opts.imageUploadParams.hasOwnProperty(n) && p.setRequestHeader(n, A.opts.imageUploadParams[n]);
    ...
    function V(e) {
      ...
      if (t && t.files && t.files.length) {
        ...
        if (a && a.type && -1 !== a.type.indexOf("image") && 0 <= A.opts.imageAllowedTypes.indexOf(a.type.replace(/image\//g, ""))) {
          ...
          A.markers.remove(), A.markers.insertAtPoint(e.originalEvent), A.$el.find(".fr-marker").replaceWith(Ne.MARKERS), 0 === A.$el.find(".fr-marker").length && A.selection.setAtEnd(A.el), A.popups.hideAll();
    ...
    function j() {
      ...
      e || (e = q()), z(), A.popups.refresh("image.alt"), A.popups.setContainer("image.alt", A.$sc);
      var t = we();
    ...
    function te(e) {
      (e = e || we()) && !1 !== A.events.trigger("image.beforeRemove", [e]) && (A.popups.hideAll(), be(), fe(!0), A.undo.canDo() || A.undo.saveStep(), e.get(0) == A.el ? e.removeAttr("src") : (e.get(0).parentNode && "A" == e.get(0).parentNode.tagName ? (A.selection.setBefore(e.get(0).parentNode) || A.selection.setAfter(e.get(0).parentNode) || e.parent().after(Ne.MARKERS), S(e.get(0).parentNode).remove()) : (A.selection.setBefore(e.get(0)) || A.selection.setAfter(e.get(0)) || e.after(Ne.MARKERS), e.remove()), A.html.fillEmptyBlocks(), A.selection.restore()), A.undo.saveStep())
    }

    function ae(e) {
      var t = e.which;
      if (C && (t == Ne.KEYCODE.BACKSPACE || t == Ne.KEYCODE.DELETE)) return e.preventDefault(), e.stopPropagation(), te(), !1;
      if (C && t == Ne.KEYCODE.ESC) {
        var a = C;
        return fe(!0), A.selection.setAfter(a.get(0)), A.selection.restore(), e.preventDefault(), !1
      }
      if (!C || t != Ne.KEYCODE.ARROW_LEFT && t != Ne.KEYCODE.ARROW_RIGHT) return C && t === Ne.KEYCODE.TAB ? (e.preventDefault(), e.stopPropagation(), fe(!0), !1) : C && t != Ne.KEYCODE.F10 && !A.keys.isBrowserAction(e) ? (e.preventDefault(), e.stopPropagation(), !1) : void 0;
      var i = C.get(0);
      return fe(!0), t == Ne.KEYCODE.ARROW_LEFT ? A.selection.setBefore(i) : A.selection.setAfter(i), A.selection.restore(), e.preventDefault(), !1
    }
    ...
    function ie(e) {
      if (e && "IMG" == e.tagName) {
        ...
        for (var i = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), n = 0; n < i.length; n++) ie(i[n])
    }
    ...
    function pe(e) {
      ...
      for (var t = 0; t < Ne.INSTANCES.length; t++) Ne.INSTANCES[t] != A && Ne.INSTANCES[t].events.trigger("image.hideResizer");
    ...
    function fe(e) {
      C && (function t() {
        return ge
      }() || !0 === e) && (A.toolbar.enable(), l.removeClass("fr-active"), A.popups.hide("image.edit"), C = null, de(), p = null, f && f.hide())
    }
    ...
    return {
      _init: function Ce() {
        ...
        (function e() {
          A.events.$on(A.$el, A._mousedown, "IMG" == A.el.tagName ? null : 'img:not([contenteditable="false"])', function (e) {
          ...
          }, !0), A.events.on("drop", V), A.events.on("element.beforeDrop", G), A.events.on("window.mousedown", ce), A.events.on("window.touchmove", de), A.events.on("mouseup window.mouseup", function () {
            if (C) return fe(), !1;
            de()
            ...
            A.node.isElement(t) && (A.opts.enter === Ne.ENTER_BR ? e.after("<br>") : S(A.node.blockParent(e.get(0))).after("<".concat(A.html.defaultTag(), "><br></").concat(A.html.defaultTag(), ">")))
          })
          ...
          if (C && e.which == Ne.KEYCODE.ENTER) return !1
        }, !0), A.events.$on(A.$el, "keydown", function () {
          var e = A.selection.element();
          (e.nodeType === Node.TEXT_NODE || "BR" == e.tagName && A.node.isLastSibling(e)) && (e = e.parentNode), A.node.hasClass(e, "fr-inner") || (A.node.hasClass(e, "fr-img-caption") || (e = S(e).parents(".fr-img-caption").get(0)), A.node.hasClass(e, "fr-img-caption") && (S(e).after(Ne.INVISIBLE_SPACE + Ne.MARKERS), A.selection.restore()))
          ...
          if (C && A.popups.isVisible("image.edit") && !A.popups.get("image.edit").find(":focus").length) {
            var t = we();
            Ae() ? (t.before(Ne.START_MARKER), t.after(Ne.END_MARKER), A.selection.restore(), A.paste.saveCopiedText(t.get(0).outerHTML, t.text())) : (be(), A.paste.saveCopiedText(C.get(0).outerHTML, C.attr("alt"))), "copy" == e.type ? setTimeout(function () {
              O(C)
          ...
          var t = e.which;
          t == Ne.KEYCODE.C && A.keys.ctrlKey(e) ? A.events.trigger("window.copy") : t == Ne.KEYCODE.X && A.keys.ctrlKey(e) && A.events.trigger("window.cut")
        }), A.events.$on(S(A.o_win), "keydown", function (e) {
          var t = e.which;
          if (C && t == Ne.KEYCODE.BACKSPACE) return e.preventDefault(), !1
        }), A.events.$on(A.$win, "keydown", function (e) {
          var t = e.which;
          C && C.hasClass("fr-uploading") && t == Ne.KEYCODE.ESC && C.trigger("abortUpload")
        ...
        }), P(!0), X(!0), Z(!0), q(!0), A.events.on("node.remove", function (e) {
      ...
      showLayer: function Ee(e) {
        var t, a, i = A.popups.get("image.insert");
      ...
      refreshByURLButton: function Ue(e) {
        var t = A.popups.get("image.insert");
      ...
      applyStyle: function ze(e, t, a) {
        ...
        "object" == Le(t[e]) ? (i.removeAttr("style"), i.css(t[e].style)) : i.toggleClass(e), O(C)
      },
      showAltPopup: j,
      showSizePopup: Q,
      setAlt: function ke(e) {
        if (C) {
      ...
      toggleCaption: function Oe() {
        var e;
        if (C && !Ae()) {
          (e = C).parent().is("a") && (e = C.parent());
          var t, a, i = C.parents("ul") && 0 < C.parents("ul").length ? C.parents("ul") : C.parents("ol") && 0 < C.parents("ol").length ? C.parents("ol") : [];
          if (0 < i.length) {
          ...
          e.wrap('<div class="fr-img-space-wrap"><span ' + (A.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + C.attr("class") + '" style="' + (A.opts.useClasses ? "" : e.attr("style")) + '" draggable="false"></span><p class="fr-img-space-wrap2">&nbsp;</p></div>'), e.wrap('<span class="fr-img-wrap"></span>'), C.after('<span class="fr-inner"'.concat(A.browser.mozilla ? "" : ' contenteditable="true"', ">").concat(Ne.START_MARKER).concat(A.language.translate("Image Caption")).concat(Ne.END_MARKER, "</span>")), C.removeAttr("class").removeAttr("style").removeAttr("width"), C.parents(".fr-img-caption").css("width", s), fe(!0), A.selection.restore()
        } else e = we(), C.insertAfter(e), C.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), O(C)
      },
      hasCaption: Ae,
      exitEdit: fe,
      edit: O
    }
  }, Ne.DefineIcon("insertImage", {
    NAME: "image",
    SVG_KEY: "insertImage"
  }), Ne.RegisterShortcut(Ne.KEYCODE.P, "insertImage", null, "P"), Ne.RegisterCommand("insertImage", {
    title: "Insert Image",
    undo: !1,
    focus: !0,
    ...
    plugin: "image"
  }), Ne.DefineIcon("imageUpload", {
    NAME: "upload",
    SVG_KEY: "upload"
  }), Ne.RegisterCommand("imageUpload", {
    title: "Upload Image",
    undo: !1,
    focus: !1,
    toggle: !0,
  ...
  }), Ne.DefineIcon("imageByURL", {
    NAME: "link",
    SVG_KEY: "insertLink"
  }), Ne.RegisterCommand("imageByURL", {
    title: "By URL",
    undo: !1,
    focus: !1,
    toggle: !0,
  ...
  }), Ne.RegisterCommand("imageInsertByURL", {
    title: "Insert Image",
    undo: !0,
    refreshAfterCallback: !1,
    callback: function () {
  ...
  }), Ne.DefineIcon("imageDisplay", {
    NAME: "star",
    SVG_KEY: "imageDisplay"
  }), Ne.RegisterCommand("imageDisplay", {
    title: "Display",
    type: "dropdown",
    options: {
      inline: "Inline",
  ...
  }), Ne.DefineIcon("image-align", {
    NAME: "align-left",
    SVG_KEY: "alignLeft"
  }), Ne.DefineIcon("image-align-left", {
    NAME: "align-left",
    SVG_KEY: "alignLeft"
  }), Ne.DefineIcon("image-align-right", {
    NAME: "align-right",
    SVG_KEY: "alignRight"
  }), Ne.DefineIcon("image-align-center", {
    NAME: "align-justify",
    SVG_KEY: "alignCenter"
  }), Ne.DefineIcon("imageAlign", {
    NAME: "align-justify",
    SVG_KEY: "alignJustify"
  }), Ne.RegisterCommand("imageAlign", {
    type: "dropdown",
    title: "Align",
    options: {
      left: "Align Left",
    ...
    html: function () {
      var e = '<ul class="fr-dropdown-list" role="presentation">',
        t = Ne.COMMANDS.imageAlign.options;
  ...
  }), Ne.DefineIcon("imageReplace", {
    NAME: "exchange",
    FA5NAME: "exchange-alt",
    SVG_KEY: "replaceImage"
  }), Ne.RegisterCommand("imageReplace", {
    title: "Replace",
    undo: !1,
    focus: !1,
    popup: !0,
  ...
  }), Ne.DefineIcon("imageRemove", {
    NAME: "trash",
    SVG_KEY: "remove"
  }), Ne.RegisterCommand("imageRemove", {
    title: "Remove",
    callback: function () {
      this.image.remove()
    }
  }), Ne.DefineIcon("imageBack", {
    NAME: "arrow-left",
    SVG_KEY: "back"
  }), Ne.RegisterCommand("imageBack", {
    title: "Back",
    undo: !1,
    focus: !1,
    back: !0,
  ...
  }), Ne.RegisterCommand("imageDismissError", {
    title: "OK",
    undo: !1,
    callback: function () {
      this.image.hideProgressBar(!0)
    }
  }), Ne.DefineIcon("imageStyle", {
    NAME: "magic",
    SVG_KEY: "imageClass"
  }), Ne.RegisterCommand("imageStyle", {
    title: "Style",
    type: "dropdown",
    html: function () {
      var e = '<ul class="fr-dropdown-list" role="presentation">',
  ...
  }), Ne.DefineIcon("imageAlt", {
    NAME: "info",
    SVG_KEY: "imageAltText"
  }), Ne.RegisterCommand("imageAlt", {
    undo: !1,
    focus: !1,
    popup: !0,
  ...
  }), Ne.RegisterCommand("imageSetAlt", {
    undo: !0,
    focus: !1,
    title: "Update",
    refreshAfterCallback: !1,
  ...
  }), Ne.DefineIcon("imageSize", {
    NAME: "arrows-alt",
    SVG_KEY: "imageSize"
  }), Ne.RegisterCommand("imageSize", {
    undo: !1,
    focus: !1,
    popup: !0,
    title: "Change Size",
  ...
  }), Ne.RegisterCommand("imageSetSize", {
    undo: !0,
    focus: !1,
    title: "Update",
    refreshAfterCallback: !1,
  ...
  }), Ne.DefineIcon("imageCaption", {
    NAME: "commenting",
    FA5NAME: "comment-alt",
    SVG_KEY: "imageCaption"
  }), Ne.RegisterCommand("imageCaption", {
    undo: !0,
    focus: !1,
    title: "Image Caption",
