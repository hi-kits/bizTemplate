  ...
  V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), V.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", V.LinkRegExTLD = "((".concat(V.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), V.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(V.LinkRegExCommon, ")"), V.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(V.LinkRegExCommon, ")"), V.LinkRegExWWW = "(www\\.".concat(V.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), V.LinkRegEx = "(".concat(V.LinkRegExTLD, "|").concat(V.LinkRegExHTTP, "|").concat(V.LinkRegExWWW, "|").concat(V.LinkRegExAuth, ")").concat(V.LinkRegExEnd), V.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], V.MAIL_REGEX = /.+@.+\..+/i, V.MODULES.helpers = function (i) {
    ...
    return {
      ...
      sanitizeURL: function m(e) {
        return /^(mpaas:|apicloud:|https?:|ftps?:|)\/\//i.test(e) ? e : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ? e : new RegExp("^(".concat(V.LinkProtocols.join("|"), "):"), "i").test(e) ? e : e = encodeURIComponent(e).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/%3A(\d)/gi, ":$1").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}")
      },
    ...
    return {
      ...
      _del: function f(e) {
        ...
        if (r) {
          ...
          if (s === g.el) return !1;
          if (s = s.nextSibling, g.node.isBlock(s)) V.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (C(e).replaceWith(V.MARKERS), (t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && C(t[t.length - 1]).remove(), C(n).append(C(s).html()), C(s).remove());
          else
            for ((t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && C(t[t.length - 1]).remove(), C(e).replaceWith(V.MARKERS); s && !g.node.isBlock(s) && "BR" !== s.tagName;) C(n).append(C(s)), s = s.nextSibling
        }
      }
    }
      ...
      if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
        ...
        if (n.nodeType === Node.TEXT_NODE) {
          ...
          if (0 === n.textContent.length)
            if (i && u.opts.keepFormatOnDelete) h(n).after(V.INVISIBLE_SPACE + V.MARKERS);
            else if (0 !== r.length && u.node.isBlock(n.parentNode)) h(n).after(V.MARKERS);
        ...
        if (u.node.isDeletable(n)) h(e).replaceWith(V.MARKERS), h(n).remove();
        else if (u.node.isEmpty(n) && !u.node.isList(n)) h(n).remove(), h(e).replaceWith(V.MARKERS);
      else {
    ...
    function s(e) {
      ...
      if (null !== n) {
        ...
        if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && i && V.NO_DELETE_TAGS.indexOf(i.tagName) < 0)
          if (u.node.isDeletable(i)) h(i).remove(), h(e).replaceWith(V.MARKERS);
          else if (u.node.isBlock(i) && u.node.isEditable(i))
          if (u.node.isList(i))
            if (u.node.isEmpty(n, !0)) h(n).remove(), h(i).find("li").first().prepend(V.MARKERS);
            else {
    ...
    function n(e) {
      ...
      if ("BR" === (n = n.nextSibling).tagName && u.node.isEditable(n))
        ...
        else u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && V.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && h(n).remove(), s(e));
        return
      }
      if (!u.node.isBlock(n) && u.node.isEditable(n)) {
        ...
        if (u.node.isDeletable(n)) h(e).replaceWith(V.MARKERS), h(n).remove();
        else if (u.node.isList(n)) e.previousSibling ? (h(n).find("li").first().prepend(e), u.cursorLists._backspace(e)) : (h(n).find("li").first().prepend(V.MARKERS), h(e).remove());
    ...
    function l(e, t, n) {
      ...
      if (null === o)(r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : !e.previousSibling || h(e.previousSibling).is("br") || e.nextSibling ? h(e).replaceWith("<br>".concat(V.MARKERS)) : h(e).replaceWith("<br>".concat(V.MARKERS, "<br>"));
      else {
        var i = e,
          a = "";
    ...
    function m(e, t, n) {
      ...
      if (null === r) u.html.defaultTag() && e.parentNode === u.el ? h(e).replaceWith("<".concat(u.html.defaultTag(), ">").concat(V.MARKERS, "<br></").concat(u.html.defaultTag(), ">")) : (e.nextSibling && !u.node.isBlock(e.nextSibling) || h(e).after("<br>"), h(e).replaceWith("<br>".concat(V.MARKERS)));
      else if (e.previousSibling && "IMG" == e.previousSibling.tagName || e.nextSibling && "IMG" == e.nextSibling.tagName) h(e).replaceWith("<" + u.html.defaultTag() + ">" + V.MARKERS + "<br></" + u.html.defaultTag() + ">");
      else {
        var o = e,
          i = "";
        ...
        do {
          var l = o;
          if (o = o.parentNode, "BLOCKQUOTE" === r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && h(l).contains(e) && h(l).after(e), "BLOCKQUOTE" !== r.tagName || !C(e, o) && !g(e, o))
        ...
        if ("BLOCKQUOTE" === r.tagName)
          if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" === e.nextSibling.tagName && (h(e.nextSibling).after(e), e.nextSibling && "BR" === e.nextSibling.tagName && h(e.nextSibling).remove()), t) i = a + i + V.MARKERS + s;
          else {
    ...
    return {
      enter: function v(e) {
        ...
        0 < h(t).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), h(t).parentsUntil(u.$el, "TD, TH").length && (r = !1), i(t) ? !c(t) || e || r ? l(t, e, r) : u.cursorLists._endEnter(t) : a(t) ? !c(t) || e || r ? function s(e, t, n) {
            ...
            if (null === o)(r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(V.MARKERS, "<br></").concat(r, ">")) : h(e).replaceWith("<br>".concat(V.MARKERS));
            else {
              if (u.node.isBlock(o))
                if ("PRE" === o.tagName && (t = !0), t) h(e).remove(), h(o).prepend("<br>".concat(V.MARKERS));
                else if (e.nextSibling && "IMG" == e.nextSibling.tagName || e.nextSibling && e.nextSibling.nextElementSibling && "IMG" == e.nextSibling.nextElementSibling) h(e).replaceWith("<" + u.html.defaultTag() + ">" + V.MARKERS + "<br></" + u.html.defaultTag() + ">");
              else {
          ...
          }(t, e, r) : u.cursorLists._startEnter(t) : !c(t) || e || r ? m(t, e, r) : u.cursorLists._middleEnter(t),
          function o() {
          ...
          if (null !== n) {
            ...
            if (u.node.isBlock(n) && u.node.isEditable(n))
              if (a && V.NO_DELETE_TAGS.indexOf(a.tagName) < 0) {
                if (u.node.isDeletable(a)) h(a).remove(), h(e).replaceWith(V.MARKERS);
                else if (u.node.isEditable(a))
                  if (u.node.isBlock(a))
                    if (u.node.isEmpty(a) && !u.node.isList(a)) h(a).remove(), h(e).after(u.opts.keepFormatOnDelete ? V.INVISIBLE_SPACE : "");
                    else {
    ...
    function C(e, t, n) {
      if (e) {
        ...
        if (e) {
          if (v.node.isBlock(e) && "HR" !== e.tagName) return v.node.hasClass(e.firstChild, "fr-marker") ? C(e.firstChild.nextSibling, t, n) : C(e.firstChild, t, n), !1;
          var r = b(v.doc.createElement(t));
          r.attr(n), r.insertBefore(e);
          for (var o = e; o && !b(o).is(".fr-marker") && 0 === b(o).find(".fr-marker").length && "UL" !== o.tagName && "OL" !== o.tagName;) {
            var i = o;
            if (v.node.isBlock(o) && "HR" !== e.tagName) return C(o.firstChild, t, n), !1;
            o = o.nextSibling, r.append(i)
          }
          if (o) {
            if (b(o).find(".fr-marker").length || "UL" === o.tagName || "OL" === o.tagName) C(o.firstChild, t, n);
            else if (v.browser.mozilla && v.node.hasClass(o, "fr-marker")) {
              var a, s = v.selection.blocks(),
                l = s.length;
              for (a = 0; a < l; a++) s[a] != o.parentNode && s[a].childNodes.length && s[a].childNodes[0] != o.parentNode && (o = s[a].childNodes[1] || s[a].childNodes[0], (r = b(f(t, n)).insertBefore(o)).append(o))
            }
          } else {
            for (var c = r.get(0).parentNode; c && !c.nextSibling && !v.node.isElement(c);) c = c.parentNode;
            if (c) {
              var d = c.nextSibling;
              d && (v.node.isBlock(d) ? "HR" === d.tagName ? C(d.nextSibling, t, n) : C(d.firstChild, t, n) : C(d, t, n))
            }
          }
          r.is(":empty") && r.remove()
        }
    ...
    function n(e, t) {
      var n;
      if (void 0 === t && (t = {}), t.style && delete t.style, v.selection.isCollapsed()) {
        v.markers.insert(), v.$el.find(".fr-marker").replaceWith(f(e, t) + V.INVISIBLE_SPACE + V.MARKERS + function a(e) {
          return "</".concat(e, ">")
        }(e)), v.selection.restore()
      } else {
        var r;
        v.selection.save(), C(v.$el.find('.fr-marker[data-type="true"]').length && v.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling, e, t);
        do {
          for (r = v.$el.find("".concat(L(e, t), " > ").concat(L(e, t))), n = 0; n < r.length; n++) r[n].outerHTML = r[n].innerHTML
        } while (r.length);
        v.el.normalize();
        var o = v.el.querySelectorAll(".fr-marker");
        for (n = 0; n < o.length; n++) {
          var i = b(o[n]);
          !0 === i.data("type") ? E(i.get(0).nextSibling, L(e, t)) && i.next().prepend(i) : E(i.get(0).previousSibling, L(e, t)) && i.prev().append(i)
        }
        v.selection.restore()
      }
    }
    ...
    function y(e, t, n, r) {
      if (!r) {
        var o = !1;
        if (!0 === e.data("type"))
          for (; v.node.isFirstSibling(e.get(0)) && !e.parent().is(v.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().before(e), o = !0;
        else if (!1 === e.data("type"))
          for (; v.node.isLastSibling(e.get(0)) && !e.parent().is(v.$el) && !e.parent().is("ol") && !e.parent().is("ul");) e.parent().after(e), o = !0;
        if (o) return !0
      }
      if (e.parents(t).length || void 0 === t) {
        var i, a = "",
          s = "",
          l = e.parent();
        if (l.is(v.$el) || v.node.isBlock(l.get(0))) return !1;
        for (; !(v.node.isBlock(l.parent().get(0)) || void 0 !== t && E(l.get(0), L(t, n)));) a += v.node.closeTagString(l.get(0)), s = v.node.openTagString(l.get(0)) + s, l = l.parent();
        var c = e.get(0).outerHTML;
        return e.replaceWith('<span id="mark"></span>'), i = l.html().replace(/<span id="mark"><\/span>/, a + v.node.closeTagString(l.get(0)) + s + c + a + v.node.openTagString(l.get(0)) + s), l.replaceWith(v.node.openTagString(l.get(0)) + i + v.node.closeTagString(l.get(0))), !0
      }
      return !1
    }
    ...
    function r(e, t) {
      ...
      var n = v.selection.isCollapsed();
      v.selection.save();
      for (var r = !0; r;) {
        r = !1;
        for (var o = v.$el.find(".fr-marker"), i = 0; i < o.length; i++) {
          var a = b(o[i]),
            s = null;
        ...
        for (var o = v.node.contents(e.get(0)), i = 0; i < o.length; i++) {
          var a = o[i];
          if (a.innerHTML && 8203 == a.innerHTML.charCodeAt() && a.tagName.toLocaleLowerCase() == n && (a.outerHTML = a.innerHTML), v.node.hasClass(a, "fr-marker")) t = (t + 1) % 2;
          else if (t)
            if (0 < b(a).find(".fr-marker").length) t = C(b(a), t, n, r);
            else {
              for (var s = b(a).find(n || "*:not(br)"), l = s.length - 1; 0 <= l; l--) {
                var c = s[l];
                v.node.isBlock(c) || v.node.isVoid(c) || void 0 !== n && !E(c, L(n, r)) ? v.node.isBlock(c) && void 0 === n && "TABLE" !== a.tagName && v.node.clearAttributes(c) : v.node.hasClass(c, "fr-clone") || (c.outerHTML = c.innerHTML)
              }
              void 0 === n && a.nodeType === Node.ELEMENT_NODE && !v.node.isVoid(a) || E(a, L(n, r)) ? v.node.isBlock(a) || v.node.hasClass(a, "fr-clone") || (a.outerHTML = a.innerHTML) : void 0 === n && a.nodeType === Node.ELEMENT_NODE && v.node.isBlock(a) && "TABLE" !== a.tagName && v.node.clearAttributes(a)
            }
          else 0 < b(a).find(".fr-marker").length && (t = C(b(a), t, n, r))
        }
        return t
      }(v.$el, 0, e, t), n || (v.$el.find(".fr-marker").remove(), v.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")), n && v.$el.find(".fr-marker").before(V.INVISIBLE_SPACE).after(V.INVISIBLE_SPACE), v.html.cleanEmptyTags(), v.el.normalize(), v.selection.restore();
      var l = v.win.getSelection() && v.win.getSelection().anchorNode;
      if (l) {
        var c = v.node.blockParent(l),
          d = !!l.textContent.replace(/\u200B/g, "").length,
          f = v.win.getSelection().getRangeAt(0),
          p = f.startOffset,
          u = f.endOffset;
        v.selection.text().replace(/\u200B/g, "").length || function m(e, t) {
          if (e && t) {
        ...
        var h = v.win.getSelection().getRangeAt(0);
        if (l.nodeType === Node.TEXT_NODE && (!d || !v.selection.text().length && p === u)) {
    ...
    function t(e, t) {
      ...
      if (v.selection.isCollapsed()) {
        v.markers.insert();
        var l = (r = v.$el.find(".fr-marker")).parent();
        if (v.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
          if (v.node.isEmpty(l.get(0))) s = b(v.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)), l.replaceWith(s);
          else {
            var c = {};
            c["style*"] = "".concat(e, ":"), y(r, "span", c, !0), r = v.$el.find(".fr-marker"), t ? (s = b(v.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(V.INVISIBLE_SPACE).concat(V.MARKERS)), r.replaceWith(s)) : r.replaceWith(V.INVISIBLE_SPACE + V.MARKERS)
          }
          v.html.cleanEmptyTags()
        } else v.node.isEmpty(l.get(0)) && l.is("span") ? (r.replaceWith(V.MARKERS), l.css(e, t)) : (s = b('<span style="'.concat(e, ": ").concat(t, ';">').concat(V.INVISIBLE_SPACE).concat(V.MARKERS, "</span>")), r.replaceWith(s));
        s && m(s, e, t)
      } else {
        if (v.selection.save(), null === t || "color" === e && 0 < v.$el.find(".fr-marker").parents("u, a").length) {
          var d = v.$el.find(".fr-marker");
          for (n = 0; n < d.length; n++)
            if (!0 === (r = b(d[n])).data("type") || "true" === r.data("type"))
              for (; v.node.isFirstSibling(r.get(0)) && !r.parent().is(v.$el) && !v.node.isElement(r.parent().get(0)) && !v.node.isBlock(r.parent().get(0));) r.parent().before(r);
            else
              for (; v.node.isLastSibling(r.get(0)) && !r.parent().is(v.$el) && !v.node.isElement(r.parent().get(0)) && !v.node.isBlock(r.parent().get(0));) r.parent().after(r)
        }
        for (var f = v.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling; f.firstChild;) f = f.firstChild;
        var p = {
          "class": "fr-unprocessed"
        };
        for (t && (p.style = "".concat(e, ": ").concat(t, ";")), C(f, "span", p), v.$el.find(".fr-marker + .fr-unprocessed").each(function () {
            b(this).prepend(b(this).prev())
          }), v.$el.find(".fr-unprocessed + .fr-marker").each(function () {
            b(this).prev().append(b(this))
          }), (t || "").match(/\dem$/) && v.$el.find("span.fr-unprocessed").removeClass("fr-unprocessed"); 0 < v.$el.find("span.fr-unprocessed").length;) {
          if ((s = v.$el.find("span.fr-unprocessed").first().removeClass("fr-unprocessed")).parent().get(0).normalize(), s.parent().is("span") && 1 === s.parent().get(0).childNodes.length) {
            s.parent().css(e, t);
            var u = s;
            s = s.parent(), u.replaceWith(u.html())
          }
          var h = s.find("span");
          for (n = h.length - 1; 0 <= n; n--) o = h[n], i = e, a = void 0, (a = b(o)).css(i, ""), "" === a.attr("style") && a.replaceWith(a.html());
          m(s, e, t)
        }
      }! function g() {
        var e;
        for (; 0 < v.$el.find(".fr-split:empty").length;) v.$el.find(".fr-split:empty").remove();
        v.$el.find(".fr-split").removeClass("fr-split"), v.$el.find('[style=""]').removeAttr("style"), v.$el.find('[class=""]').removeAttr("class"), v.html.cleanEmptyTags();
        for (var t = v.$el.find("span"), n = t.length - 1; 0 <= n; n--) {
          var r = t[n];
          r.attributes && 0 !== r.attributes.length || b(r).replaceWith(r.innerHTML)
        }
        v.el.normalize();
        var o = v.$el.find("span[style] + span[style]");
        for (e = 0; e < o.length; e++) {
          var i = b(o[e]),
            a = b(o[e]).prev();
          i.get(0).previousSibling === a.get(0) && v.node.openTagString(i.get(0)) === v.node.openTagString(a.get(0)) && (i.prepend(a.html()), a.remove())
        }
        v.$el.find("span[style] span[style]").each(function () {
          if (0 <= b(this).attr("style").indexOf("font-size")) {
            var e = b(this).parents("span[style]");
            0 <= e.attr("style").indexOf("background-color") && (b(this).attr("style", "".concat(b(this).attr("style"), ";").concat(e.attr("style"))), y(b(this), "span[style]", {}, !1))
          }
        }), v.el.normalize(), v.selection.restore()
      }()
    }

    function m(e, t, n) {
      var r, o, i, a = e.parentsUntil(v.$el, "span[style]"),
        s = [];
      for (r = a.length - 1; 0 <= r; r--) o = a[r], i = t, 0 === b(o).attr("style").indexOf("".concat(i, ":")) || 0 <= b(o).attr("style").indexOf(";".concat(i, ":")) || 0 <= b(o).attr("style").indexOf("; ".concat(i, ":")) || s.push(a[r]);
      if ((a = a.not(s)).length) {
        for (var l = "", c = "", d = "", f = "", p = e.get(0); p = p.parentNode, b(p).addClass("fr-split"), l += v.node.closeTagString(p), c = v.node.openTagString(b(p).clone().addClass("fr-split").get(0)) + c, a.get(0) !== p && (d += v.node.closeTagString(p), f = v.node.openTagString(b(p).clone().addClass("fr-split").get(0)) + f), a.get(0) !== p;);
        var u = "".concat(l + v.node.openTagString(b(a.get(0)).clone().css(t, n || "").get(0)) + f + e.css(t, "").get(0).outerHTML + d, "</span>").concat(c);
        e.replaceWith('<span id="fr-break"></span>');
        var h = a.get(0).outerHTML;
        b(a.get(0)).replaceWith(h.replace(/<span id="fr-break"><\/span>/g, function () {
          return u
        }))
      }
    }
    ...
    function o(e, t) {
      ...
      if (r.nodeType === Node.ELEMENT_NODE && 0 < r.childNodes.length && r.childNodes[n.startOffset] && (r = r.childNodes[n.startOffset]), !n.collapsed && r.nodeType === Node.TEXT_NODE && n.startOffset === (r.textContent || "").length) {
        for (; !v.node.isBlock(r.parentNode) && !r.nextSibling;) r = r.parentNode;
        r.nextSibling && (r = r.nextSibling)
      }
      for (var o = r; o && o.nodeType === Node.ELEMENT_NODE && !E(o, L(e, t));) o = o.firstChild;
      if (o && o.nodeType === Node.ELEMENT_NODE && E(o, L(e, t))) return !0;
      var i = r;
      for (i && i.nodeType !== Node.ELEMENT_NODE && (i = i.parentNode); i && i.nodeType === Node.ELEMENT_NODE && i !== v.el && !E(i, L(e, t));) i = i.parentNode;
      return !(!i || i.nodeType !== Node.ELEMENT_NODE || i === v.el || !E(i, L(e, t)))
    }
    return {
      is: o,
    ...
    function p() {
      try {
        if (!E.$wp) return !1;
        for (var e = d(0).commonAncestorContainer; e && !E.node.isElement(e);) e = e.parentNode;
      ...
      blocks: function h() {
        ...
        if (p() && r.rangeCount) {
          ...
          for (e = 0; e < o.length; e++) {
            ...
            for (var l = [], c = a; c !== s && c !== E.el;) l.indexOf(c) < 0 && c.children && c.children.length ? (l.push(c), c = c.children[0]) : c.nextSibling ? c = c.nextSibling : c.parentNode && (c = c.parentNode, l.push(c)), E.node.isBlock(c) && l.indexOf(c) < 0 && n.indexOf(c) < 0 && (c !== s || 0 < i.endOffset) && n.push(c);
    ...
    function o(e, t, n) {
      ...
      if (!t)
        if ((l = function E(e) {
          ...
          }(e)) && (e = N.win.localStorage.getItem("fr-copied-html")), l) e = N.clean.html(e, N.opts.pasteDeniedTags, N.opts.pasteDeniedAttrs);
        else {
    ...
    function r() {
      if (m !== C.helpers.screenSize()) {
        var e = b(),
          t = v(),
          n = v();
        for (var r in C.$tb.find(".fr-btn-grp > .fr-command, .fr-more-toolbar > .fr-command, .fr-btn-grp > .fr-btn-wrap > .fr-command, .fr-more-toolbar > .fr-btn-wrap > .fr-command").addClass("fr-hidden"),
            function g() {
