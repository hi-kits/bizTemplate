...
! function (e, t) {
  ...
  ye = ye && ye.hasOwnProperty("default") ? ye.default : ye, Object.assign(ye.POPUP_TEMPLATES, {
    ...
    function x(s, e, l, f, p) {
      ...
      var v = function v() {
        ...
        if (f) {
          ...
          if (void 0 !== l)
            for (t in l) l.hasOwnProperty(t) && "link" != t && e.find("video").attr("data-".concat(t), l[t]);
          ...
          var i, r = "";
          if (t && void 0 !== t)
            for (i in t) t.hasOwnProperty(i) && "link" != i && (r += " data-".concat(i, '="').concat(t[i], '"'));
          var a = w.opts.videoDefaultWidth;
          a && "auto" != a && (a = "".concat(a, "px"));
          var n = A(document.createElement("span")).attr("contenteditable", "false").attr("draggable", "true").attr("class", "fr-video fr-dv" + w.opts.videoDefaultDisplay[0] + ("center" != w.opts.videoDefaultAlign ? " fr-fv" + w.opts.videoDefaultAlign[0] : "")).html('<video src="' + e + '" ' + r + (a ? ' style="width: ' + a + ';" ' : "") + " controls></video>");
    ...
    function L() {
      var e, t = Array.prototype.slice.call(w.el.querySelectorAll("video, .fr-video > *")),
        o = [];
      for (e = 0; e < t.length; e++) o.push(t[e].getAttribute("src")), A(t[e]).toggleClass("fr-draggable", w.opts.videoMove), "" === t[e].getAttribute("class") && t[e].removeAttribute("class"), "" === t[e].getAttribute("style") && t[e].removeAttribute("style");
      if (i)
        for (e = 0; e < i.length; e++) o.indexOf(i[e].getAttribute("src")) < 0 && w.events.trigger("video.removed", [A(i[e])]);
      i = t
    }
    ...
    function t(e) {
      ...
      for (var t = 0; t < ye.INSTANCES.length; t++) ye.INSTANCES[t] != w && ye.INSTANCES[t].events.trigger("video.hideResizer");
      ...
      if (void 0 !== e && 0 < e.length) {
        ...
        if (w.drag_support.formdata && (t = w.drag_support.formdata ? new FormData : null), t) {
          ...
          if (!1 !== w.opts.videoUploadToS3)
            for (i in t.append("key", w.opts.videoUploadToS3.keyStart + (new Date).getTime() + "-" + (o.name || "untitled")), t.append("success_action_status", "201"), t.append("X-Requested-With", "xhr"), t.append("Content-Type", o.type), w.opts.videoUploadToS3.params) w.opts.videoUploadToS3.params.hasOwnProperty(i) && t.append(i, w.opts.videoUploadToS3.params[i]);
          ...
          var r, a, n = w.opts.videoUploadURL;
          ...
          if (w.opts.videoUploadToAzure) {
            ...
            for (i in d.setRequestHeader("x-ms-version", "2019-07-07"), d.setRequestHeader("x-ms-date", l), d.setRequestHeader("Content-Type", o.type), d.setRequestHeader("x-ms-blob-type", "BlockBlob"), w.opts.videoUploadParams) w.opts.videoUploadParams.hasOwnProperty(i) && d.setRequestHeader(i, w.opts.videoUploadParams[i]);
    ...
    return r[1] = "Video cannot be loaded from the passed link.", r[v] = "No link in upload response.", r[c] = "Error during file upload.", r[u] = "Parsing response failed.", r[S] = "File is too large.", r[U] = "Video file type is invalid.", r[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", w.shared.vid_exit_flag = !1, {
      ...
      showLayer: function ie(e) {
        var t, o, i = w.popups.get("video.insert");
      ...
      insertByURL: function se(e) {
        ...
        if (/^http/.test(e) || (e = "https://".concat(e)), w.helpers.isURL(e))
          for (var i = 0; i < ye.VIDEO_PROVIDERS.length; i++) {
      ...
      setAutoplay: function be() {
        var e;
        if (E.find("iframe, embed, audio").get(0))(e = E.find("iframe, embed, audio")).get(0).src.includes("autoplay=1") ? (Q("#FFFFFF"), e.get(0).src = e.get(0).src.replace("&autoplay=1", "")) : (Q("#D6D6D6"), e.get(0).src = e.get(0).src + "&autoplay=1");
        else if ((e = E.find("iframe, embed, video")).get(0).outerHTML.includes(" autoplay")) Q("#FFFFFF"), e.get(0).outerHTML = e.get(0).outerHTML.replace("autoplay", "");
        else {
          Q("#D6D6D6");
